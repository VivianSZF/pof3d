...
class MipRayMarcher2(nn.Module):
    ...
    def run_forward(self, colors, densities, depths, rendering_options):
        ...
        return composite_rgb, composite_depth, weights, T[:, :, -1]


    def forward(self, colors, densities, depths, rendering_options):
        composite_rgb, composite_depth, weights, bg_lambda = self.run_forward(colors, densities, depths, rendering_options)

        return composite_rgb, composite_depth, weights, bg_lambda